            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                ...
                <v-form ref="form">
                  ...
                  <v-text-field append-icon="person" :rules="emailRules" label="Email Address" type="text" v-model="email"></v-text-field>
                ...
                <v-btn class="mt-3" :disabled="loading" @keyup.enter="login" block color="primary" @click="$router.push('/login')">Login Instead</v-btn>
            </v-card>
          </v-flex>
        </v-layout>
      </v-container>
